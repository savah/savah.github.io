...
(function() {
  ...
  function __(english) {
    const arabic = {
      ...
      'https://www.ikea.com/jo/en/profile/login/': 'https://www.ikea.com/jo/ar/profile/login/'
    };
  ...
  function modifyHeaderFooter() {
      ...
      '<li class="header__icon-list-item"><a class="header__icon-list-item-link" href="' + __('https://www.ikea.com/jo/en/profile/login/') + '"><div class="header__icon-list-item-icon">' +
