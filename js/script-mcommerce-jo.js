...
(function () {
  ...
  //shopping list AR
  if ((PrevURL === 'https://securem.ar.ikea.com/jo/ar/login/') && (window.location.href.indexOf("/jo/ar/shoppinglist/") > -1)) {
      window.location.href = "https://secure.ar.ikea.com/webapp/wcs/stores/servlet/LogonForm?storeId=46&langId=-60";
  }
  //shopping list EN
  if ((PrevURL === 'https://securem.ikea.com/jo/en/login/') && (window.location.href.indexOf("/jo/en/shoppinglist/") > -1)) {
      window.location.href = "https://secure.ikea.com/webapp/wcs/stores/servlet/LogonForm?storeId=46&langId=-60";
  }
  
  //Registration AR sa/ar/login/create/
  if (window.location.href.indexOf("/login/create/") > -1) {
      window.location.href = "https://secure.ikea.com/webapp/wcs/stores/servlet/CreateUser";
  }

  //Mobile Site Checkout Redirection
  var newCheckoutLink = "https://checkout.jo.ikea.com/checkout";
  ...
  for (var i = 0; i < ca.length; i++) {
      ...
      if (ca[i].indexOf('IRMW_USER_ID_JO') >= 0) {
          userstate = 1;
      }
  }
  ...
  if (userstate == 1) {
      if (!document.getElementById('account-icon')) {
          ...
          accountButton.href = 'https://secure.ikea.com/webapp/wcs/stores/servlet/MyProfile?catalogId=20001&storeId=46&langId=-60';
...
(function() {
  ...
  function __(english) {
    const arabic = {
      ...
      'https://secure.ikea.com/webapp/wcs/stores/servlet/LogonForm?storeId=46&langId=-60': 'https://secure.ar.ikea.com/jo/ar/webapp/wcs/stores/servlet/LogonForm?storeId=46&langId=-60'
    };
  ...
  function modifyHeaderFooter() {
      const baseURL = 'https://www.ikea.com/jo/' + lang + '/';
      ...
      '<a href="' + baseURL + '" class="head__logo"><img class="svg-icon" src="https://www.ikea.com/jo/en/static/ikea-logo.f88b07ceb5a8c356b7a0fdcc9a563d63.svg" alt="IKEA" title="IKEA"><span class="header__sr-only">IKEA</span></a>' +
      ...
      '<li class="header__icon-list-item"><a class="header__icon-list-item-link" href="' + __('https://secure.ikea.com/webapp/wcs/stores/servlet/LogonForm?storeId=37&langId=-47') + '"><div class="header__icon-list-item-icon">' +
      ...
      '<li class="header__icon-list-item"><a class="header__icon-list-item-link" href="https://order.ikea.com/jo/' + lang + '/checkout/shoppinglist"><div class="header__icon-list-item-icon">' +
      ...
      '<li class="header__icon-list-item"><a class="header__shopping-cart header__icon-list-item-link" href="https://' + www + '.ikea.com/jo/' + lang + '/mcommerce/shoppingcart"><div class="header__icon-list-item-icon js-shopping-cart-icon" data-market-code="en-JO">' +
     ...
     // headerContent = '<a href="https://www.ikea.com/sa/en/">IKEA</a>';
      ...
      if ($trustMarks) {
          $trustMarks.html('<img alt="visa card" src="https://checkout.kw.ikea.com/Themes/K3Checkout/Content/images/mc_visa_logo.png"> <img alt="amex" src="https://savah.github.io/img/amex_109.png">');
      }
      ...
      var footerHtml =
          ...
          '<li class="footer__horizontal-list-item footer__horizontal-list-item--social"><a href="https://www.facebook.com/IKEAkuwait" class="footer__link--white footer__social-link" aria-label="Facebook">' +
          ...
          '</a></li><li class="footer__horizontal-list-item footer__horizontal-list-item--social"><a href="https://www.instagram.com/ikeakuwait" class="footer__link--white footer__social-link" aria-label="Instagram">' +
          ...
          '</a></li><li class="footer__horizontal-list-item footer__horizontal-list-item--social"><a href="https://twitter.com/ikeakuwait" class="footer__link--white footer__social-link" aria-label="Twitter">' +
          ...
          '</a></li><li class="footer__horizontal-list-item footer__horizontal-list-item--social"><a href="https://www.youtube.com/ikeakuwait" class="footer__link--white footer__social-link" aria-label="Youtube">' +
