...
*/
  ...
  function __(english) {
    const arabic = {
      ...
      'https://www.ikea.com/ma/en/profile/login/': 'https://www.ikea.com/ma/ar/profile/login/'
    };
    const french = {
      'Products': 'Produits',
      'Rooms': 'Pièces',
      ...
      'https://www.ikea.com/ma/en/profile/login/': 'https://www.ikea.com/ma/fr/profile/login/'
    };
	if (lang == 'fr') {
    ...
    //return lang == 'fr' ? arabic[english] : english;
  };
  ...
  function modifyHeaderFooter() {
      ...
      '<a href="' + baseURL + '" class="head__logo"><img class="svg-icon" src="https://www.ikea.com/ma/en/static/ikea-logo.f88b07ceb5a8c356b7a0fdcc9a563d63.svg" alt="IKEA" title="IKEA"><span class="header__sr-only">IKEA</span></a>' +
      ...
      '<li class="header__icon-list-item"><a class="header__icon-list-item-link" href="' + __('https://www.ikea.com/ma/en/profile/login/') + '"><div class="header__icon-list-item-icon">' +
      ...
      '<li class="header__icon-list-item"><a class="header__icon-list-item-link" href="https://order.ikea.com/ma/' + lang + '/checkout/shoppinglist"><div class="header__icon-list-item-icon">' +
      ...
      '<li class="header__icon-list-item"><a class="header__shopping-cart header__icon-list-item-link" href="https://' + www + '.ikea.com/ma/' + lang + '/mcommerce/shoppingcart"><div class="header__icon-list-item-icon js-shopping-cart-icon" data-market-code="en-MA">' +
     ...
     // headerContent = '<a href="https://www.ikea.com/sa/en/">IKEA</a>';
      ...
      var footerHtml =
          ...
          '<li class="footer__horizontal-list-item footer__horizontal-list-item--social"><a href="https://www.facebook.com/MarocIKEA/" class="footer__link--white footer__social-link" aria-label="Facebook">' +
          ...
          '</a></li><li class="footer__horizontal-list-item footer__horizontal-list-item--social"><a href="https://www.instagram.com/ikea.maroc/" class="footer__link--white footer__social-link" aria-label="Instagram">' +
          ...
          '</a></li><li class="footer__horizontal-list-item footer__horizontal-list-item--social"><a href="https://twitter.com/ikeamaroc" class="footer__link--white footer__social-link" aria-label="Twitter">' +
          ...
          '</a></li><li class="footer__horizontal-list-item footer__horizontal-list-item--social"><a href="https://www.youtube.com/channel/UCfHWuDV6fYBeUV4cD2ZymKA" class="footer__link--white footer__social-link" aria-label="Youtube">' +
