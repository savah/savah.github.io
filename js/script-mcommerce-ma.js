...
(function() {
  ...
  function modifyHeaderFooter() {
      ...
      '<li class="header__icon-list-item"><a class="header__icon-list-item-link" href="' + __('https://secure.ikea.com/webapp/wcs/stores/servlet/LogonForm?storeId=55&langId=-83') + '"><div class="header__icon-list-item-icon">' +
