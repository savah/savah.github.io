...
(function() {
  ...
  function modifyHeaderFooter() {
      ...
      '<li class="header__icon-list-item"><a class="header__icon-list-item-link" href="' + __('https://www.ikea.com/kw/en/profile/login/') + '"><div class="header__icon-list-item-icon">' +
