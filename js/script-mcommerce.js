...
(function() {
  ...
  function modifyHeaderFooter() {
      ...
      '<a href="' + baseURL + '" class="head__logo"><img class="svg-icon" src="https://www.ikea.com/kw/en/static/ikea-logo.f88b07ceb5a8c356b7a0fdcc9a563d63.svg" alt="IKEA" title="IKEA"><span class="header__sr-only">IKEA</span></a>' +
      ...
      '<li class="header__icon-list-item"><a class="header__icon-list-item-link" href="https://order.ikea.com/kw/' + lang + '/checkout/shoppinglist"><div class="header__icon-list-item-icon">' +
      ...
      '<li class="header__icon-list-item"><a class="header__shopping-cart header__icon-list-item-link" href="https://' + www + '.ikea.com/kw/' + lang + '/mcommerce/shoppingcart"><div class="header__icon-list-item-icon js-shopping-cart-icon" data-market-code="en-KW">' +
